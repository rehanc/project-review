...
function deleteComment(url, request) {
  ...
  if (savedComment && id) {
    ...
    const userComments = database.users[savedComment.username].commentIds.indexOf(savedComment.id);
    database.users[savedComment.username].commentIds.splice(userComments, 1,);

    const articleComments = database.articles[savedComment.articleId].commentIds.indexOf(savedComment.id);
    database.articles[savedComment.articleId].commentIds.splice(articleComments, 1);
